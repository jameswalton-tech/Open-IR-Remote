...
Open IR Remote is a public, versioned interchange standard / community library for infrared remote-control codes. The goal is to give applications one predictable format to import and export instead of maintaining incompatible private databases.
